...
def graph_generator(result,graph_name):
    ...
    if graph_name == "None":
        ...
        # print(result, "__________________________result graph")
...
def get_insight(data, text):
  ...
  ],   max_tokens = 300,   frequency_penalty = 0,   presence_penalty = 0)
